...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "view",
        { staticClass: _vm._$s(2, "sc", "go-login"), attrs: { _i: 2 } },
        [
          _c("text"),
          _c(
            "text",
            { staticClass: _vm._$s(4, "sc", "login-text"), attrs: { _i: 4 } },
            [
              _c("text", {
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _backSearch = _interopRequireDefault(__webpack_require__(/*! ../../components/back-search/back-search.vue */ 85));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { data: function data() {return { likeList: [{ id: 'like-1', name: '米家驱蚊器 智能版', now_price: 59, old_price: '', imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/5ce0f98a0d5462e6fd4e1d2d111ba2a9.jpg?thumb=1&w=360&h=360' }, { id: 'like-2', name: '米家直流变频落地扇1X', now_price: 269, old_price: 299, imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/bdeb112cc683ea56dead55806cb78a55.jpg?thumb=1&w=360&h=360' }, { id: 'like-3', name: '手机USB micro 数据线', now_price: 9.9, old_price: '', imgSrc: '//i8.mifile.cn/b2c-mimall-media/652ae759d82f68d40caea9329e266044!360x360.jpg' }, { id: 'like-4', name: '米家IH电饭煲 4L', now_price: 499, old_price: 599, imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/f735084aaa49c1b832af24eca6cc5a01.jpg?thumb=1&w=360&h=360' }, { id: 'like-5', name: '电视4A 50\\\" 影院版', now_price: 1698, old_price: 2098, imgSrc: '//i8.mifile.cn/b2c-mimall-media/7bac9c4c9044173389f56b41de154f8d!360x360.jpg' },\n\n      {\n        id: 'like-6',\n        name: '米家电饭煲4L',\n        now_price: 249,\n        old_price: 299,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/2dd222540cc2c130003aaebc178c83f6.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-7',\n        name: '8H多功能青春床垫X1',\n        now_price: 349,\n        old_price: 399,\n        imgSrc: '//i8.mifile.cn/b2c-mimall-media/9a3d60e8947d19eb5cc2d2cb0e0822fa!360x360.jpg' },\n\n      {\n        id: 'like-8',\n        name: '米家洗烘一体机Pro',\n        now_price: 2999,\n        old_price: '',\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/552e42b8706ee8d0bd3e048d2a5c4316.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-9',\n        name: '米家照片打印机',\n        now_price: 499,\n        old_price: '',\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/739c1321d2a05d48c0b8b86cd459c4d4.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-10',\n        name: '小米巨能写中性笔10...',\n        now_price: 9.99,\n        old_price: '',\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/a6a8abf50e2134139e24c30c9293871c.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-11',\n        name: '米家互联网燃气灶',\n        now_price: 699,\n        old_price: 799,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/fa0f388a9e6ba57caa623e1e18e9b3fe.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-12',\n        name: '知吾煮汤锅 米家定制',\n        now_price: 99,\n        old_price: '',\n        imgSrc: '//i8.mifile.cn/b2c-mimall-media/72f7329a96a5c89bf160fba8cd2745be!360x360.jpg' },\n\n      {\n        id: 'like-13',\n        name: '米家电子温湿度计Pro',\n        now_price: 69,\n        old_price: 79,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/4fcc8cd115c4d1417d8cb7860fe66049.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-14',\n        name: '小米活塞耳机',\n        now_price: 29,\n        old_price: '',\n        imgSrc: '//i8.mifile.cn/b2c-mimall-media/e73a38fa0dca982ea6685e045d05a163!360x360.jpg' },\n\n      {\n        id: 'like-15',\n        name: '照片打印机彩色相纸',\n        now_price: 59,\n        old_price: '',\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/4e315bf299f209996e7e91b77a75512c.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-16',\n        name: '小米电视音响',\n        now_price: 399,\n        old_price: '',\n        imgSrc: '//i8.mifile.cn/b2c-mimall-media/f0ed6c9712b59561f24104553a206e3f!360x360.jpg' },\n\n      {\n        id: 'like-17',\n        name: '智睿LED灯泡 米家定制',\n        now_price: 14.9,\n        old_price: '',\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/6dd0d348fc7d5718a81c8d5a9ff63563.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-18',\n        name: '小米净水器600G',\n        now_price: 1699,\n        old_price: 2499,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/efae8106bc194e6a730294c9ee531caf.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-19',\n        name: '米家电压力锅',\n        now_price: 549,\n        old_price: 599,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/088b2e2150928479e7b425fe2117fdaa.jpg?thumb=1&w=360&h=360' },\n\n      {\n        id: 'like-20',\n        name: '8H乳胶床垫·青春版',\n        now_price: 549,\n        old_price: 599,\n        imgSrc: '//cdn.cnbj1.fds.api.mi-img.com/mi-mall/9360bfc6414561f94c66eee9d8613f1a.jpg?thumb=1&w=360&h=360' }] };\n\n\n\n  },\n  components: {\n    BackSearch: _backSearch.default },\n\n  onHide: function onHide() {\n    this.$store.commit('changeBackPage', 'pages/cart/cart');\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///114\n");
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("view", { staticClass: _vm._$s(5, "sc", "order"), attrs: { _i: 5 } }, [
        _c("view", {
          staticClass: _vm._$s(6, "sc", "my-order-text"),
          attrs: { _i: 6 }
        }),
        _c(
          "view",
          { staticClass: _vm._$s(7, "sc", "all-order"), attrs: { _i: 7 } },
          [
            _c("text", {
      ...
      _c(
        "view",
        { staticClass: _vm._$s(9, "sc", "my-order-icons"), attrs: { _i: 9 } },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(10, "sc", "no-buy view"),
              attrs: { _i: 10 }
            },
            [
              _c("image", {
                ...
                attrs: {
                  src: _vm._$s(
                    11,
                    "a-src",
                    __webpack_require__(/*! ../../static/icons/user_no_buy.png */ 118)
                  ),
                  _i: 11
                }
              }),
          ...
          _c(
            "view",
            { staticClass: _vm._$s(13, "sc", "money view"), attrs: { _i: 13 } },
            [
              _c("image", {
                staticClass: _vm._$s(14, "sc", "image"),
                attrs: {
                  src: _vm._$s(
                    14,
                    "a-src",
                    __webpack_require__(/*! ../../static/icons/user_money.png */ 119)
                  ),
                  _i: 14
                }
              }),
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(16, "sc", "service view"),
              attrs: { _i: 16 }
            },
            [
              _c("image", {
                ...
                attrs: {
                  src: _vm._$s(
                    17,
                    "a-src",
                    __webpack_require__(/*! ../../static/icons/user_service.png */ 120)
                  ),
                  _i: 17
                }
              }),
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(19, "sc", "list-item list-item1"),
          attrs: { _i: 19 }
        },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(20, "sc", "list-item-view vip"),
              attrs: { _i: 20 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(21, "sc", "icon-box"),
                  attrs: { _i: 21 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(22, "sc", "icon icon-vip"),
                    attrs: { _i: 22 }
                  })
                ]
              ),
              _c(
                "view",
                {
                  staticClass: _vm._$s(23, "sc", "text border"),
                  attrs: { _i: 23 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(24, "sc", "icon-xiangyou"),
                    attrs: { _i: 24 }
                  })
                ]
              )
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(25, "sc", "list-item-view hui"),
              attrs: { _i: 25 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(26, "sc", "icon-box"),
                  attrs: { _i: 26 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(27, "sc", "icon icon-hui"),
                    attrs: { _i: 27 }
                  })
                ]
              ),
              _c(
                ...
                [
                  _c("text", {
                    staticClass: _vm._$s(29, "sc", "icon-xiangyou"),
                    attrs: { _i: 29 }
                  })
                ]
              )
          ...
          _c(
            "view",
            { staticClass: _vm._$s(30, "sc", "view"), attrs: { _i: 30 } },
            [
              _c("text", {
                staticClass: _vm._$s(31, "sc", "icon icon-setting"),
                attrs: { _i: 31 }
              })
            ]
          )
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(32, "sc", "list-item list-item2"),
          attrs: { _i: 32 }
        },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(33, "sc", "list-item-view service"),
              attrs: { _i: 33 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(34, "sc", "icon-box"),
                  attrs: { _i: 34 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(35, "sc", "icon icon-service"),
                    attrs: { _i: 35 }
                  })
                ]
              ),
              _c(
                "view",
                {
                  staticClass: _vm._$s(36, "sc", "text border"),
                  attrs: { _i: 36 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(37, "sc", "icon-xiangyou"),
                    attrs: { _i: 37 }
                  })
                ]
              )
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(38, "sc", "list-item-view mijia"),
              attrs: { _i: 38 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(39, "sc", "icon-box"),
                  attrs: { _i: 39 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(40, "sc", "icon icon-mijia"),
                    attrs: { _i: 40 }
                  })
                ]
              ),
              _c(
                "view",
                { staticClass: _vm._$s(41, "sc", "text"), attrs: { _i: 41 } },
                [
                  _c("text", {
                    staticClass: _vm._$s(42, "sc", "icon-xiangyou"),
                    attrs: { _i: 42 }
                  })
                ]
              )
          ...
          _c(
            "view",
            { staticClass: _vm._$s(43, "sc", "view"), attrs: { _i: 43 } },
            [
              _c("text", {
                staticClass: _vm._$s(44, "sc", "icon icon-setting"),
                attrs: { _i: 44 }
              })
            ]
          )
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(45, "sc", "list-item list-item3"),
          attrs: { _i: 45 }
        },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(46, "sc", "list-item-view f-gift"),
              attrs: { _i: 46 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(47, "sc", "icon-box"),
                  attrs: { _i: 47 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(48, "sc", "icon icon-f"),
                    attrs: { _i: 48 }
                  })
                ]
              ),
              _c(
                "view",
                {
                  staticClass: _vm._$s(49, "sc", "text border"),
                  attrs: { _i: 49 }
                },
                [
                  _c("text", {
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(51, "sc", "list-item-view mijia"),
              attrs: { _i: 51 }
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(52, "sc", "icon-box"),
                  attrs: { _i: 52 }
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(53, "sc", "icon icon-gift"),
                    attrs: { _i: 53 }
                  })
                ]
              ),
              _c(
                "view",
                { staticClass: _vm._$s(54, "sc", "text"), attrs: { _i: 54 } },
                [
                  _c("text", {
          ...
          _c(
            "view",
            { staticClass: _vm._$s(56, "sc", "view"), attrs: { _i: 56 } },
            [
              _c("text", {
                staticClass: _vm._$s(57, "sc", "icon icon-setting"),
                attrs: { _i: 57 }
              })
            ]
          )
      ...
      _c(
        "view",
        { staticClass: _vm._$s(58, "sc", "setting"), attrs: { _i: 58 } },
        [
          _c(
            "view",
            { staticClass: _vm._$s(59, "sc", "icon-box"), attrs: { _i: 59 } },
            [
              _c("text", {
                staticClass: _vm._$s(60, "sc", "icon-setting"),
                attrs: { _i: 60 }
              })
            ]
          ),
          _c(
            "view",
            { staticClass: _vm._$s(61, "sc", "text"), attrs: { _i: 61 } },
            [
              _c("text", {
                staticClass: _vm._$s(62, "sc", "icon icon-xiangyou"),
                attrs: { _i: 62 }
              })
            ]
          )
...
eval("module.exports = \"/static/icons/user_no_buy.png\";//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbbnVsbF0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBIiwiZmlsZSI6IjExOC5qcyIsInNvdXJjZXNDb250ZW50IjpbIm1vZHVsZS5leHBvcnRzID0gXCIvc3RhdGljL2ljb25zL3VzZXJfbm9fYnV5LnBuZ1wiOyJdLCJzb3VyY2VSb290IjoiIn0=\n//# sourceURL=webpack-internal:///118\n");
...
eval("module.exports = \"/static/icons/user_money.png\";//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbbnVsbF0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBIiwiZmlsZSI6IjExOS5qcyIsInNvdXJjZXNDb250ZW50IjpbIm1vZHVsZS5leHBvcnRzID0gXCIvc3RhdGljL2ljb25zL3VzZXJfbW9uZXkucG5nXCI7Il0sInNvdXJjZVJvb3QiOiIifQ==\n//# sourceURL=webpack-internal:///119\n");
...
eval("module.exports = \"/static/icons/user_service.png\";//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbbnVsbF0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBIiwiZmlsZSI6IjEyMC5qcyIsInNvdXJjZXNDb250ZW50IjpbIm1vZHVsZS5leHBvcnRzID0gXCIvc3RhdGljL2ljb25zL3VzZXJfc2VydmljZS5wbmdcIjsiXSwic291cmNlUm9vdCI6IiJ9\n//# sourceURL=webpack-internal:///120\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      recList: [\n      {\n        id: 'rec-1',\n        text: 'Redmi K30 Pro',\n        imgSrc: '' },\n\n      {\n        id: 'rec-2',\n        text: '小米816主会场',\n        imgSrc: '/static/icons/huodong.png' },\n\n      {\n        id: 'rec-3',\n        text: 'K30 5G券后最高优惠700元',\n        imgSrc: '' },\n\n      {\n        id: 'rec-4',\n        text: '黑鲨',\n        imgSrc: '' },\n\n      {\n        id: 'rec-5',\n        text: '空调',\n        imgSrc: '' },\n\n      {\n        id: 'rec-6',\n        text: '小米10',\n        imgSrc: '' },\n\n      {\n        id: 'rec-7',\n        text: '电视',\n        imgSrc: '/static/icons/fenlei.png' },\n\n      {\n        id: 'rec-8',\n        text: '家电',\n        imgSrc: '/static/icons/fenlei.png' },\n\n      {\n        id: 'rec-9',\n        text: '全部商品',\n        imgSrc: '' },\n\n      {\n        id: 'rec-10',\n        text: '米家插线板 快充版 27W',\n        imgSrc: '' }] };\n\n\n\n  },\n  methods: {\n    backPage: function backPage() {\n      uni.switchTab({\n        url: \"../../\".concat(this.$store.state.backPage) });\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///127\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../HBuilderX/plugins/uniapp-cli/node_modules/babel-loader/lib!../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-1!../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/using-components.js!../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./App.vue?vue&type=script&lang=js& */ 131);\n/* harmony import */ var _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n /* harmony default export */ __webpack_exports__[\"default\"] = (_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_6_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); //# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///130\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 128));\nvar _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 133));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}\n_vue.default.use(_vuex.default);\nvar store = new _vuex.default.Store({\n  state: {\n    isLogin: false,\n    homeCurItem: 0,\n    homeSwiperItem: '', // 记录首页展示的轮播图\n    backPage: '', //用于返回按钮记录要返回的页面路径\n    homeNavScrollLeft: 0 //首页nav滚动条位置\n  },\n  mutations: {\n    changeHomeCurItem: function changeHomeCurItem(state, index) {\n      state.homeCurItem = index;\n    },\n    changeHomeSwiperItem: function changeHomeSwiperItem(state, item) {\n      state.homeSwiperItem = item;\n    },\n    changeBackPage: function changeBackPage(state, page) {\n      state.backPage = page;\n    },\n    changeCurItem: function changeCurItem(state, obj) {\n      if (obj.index >= 4) {\n        if (obj.index === obj.num - 1 || 6) {\n          state.homeNavScrollLeft = 80;\n        } else {\n          state.homeNavScrollLeft += 50;\n        }\n\n      } else {\n        state.homeNavScrollLeft = 0;\n      }\n    } },\n\n  actions: {} });var _default =\n\nstore;exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///132\n");
